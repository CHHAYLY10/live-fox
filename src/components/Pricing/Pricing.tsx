          ...
          <Link
            ...
            className={` ${
              active
                ...
                : "block w-full rounded-md border border-stroke bg-transparent p-3 text-center text-base font-medium text-primary transition hover:border-primary hover:bg-primary hover:border-green-600 dark:border-dark-3"
            } `}
          >
            {buttonText}
          </Link>
...
const List: React.FC<{ children: string }> = ({ children }) => {
  return (
